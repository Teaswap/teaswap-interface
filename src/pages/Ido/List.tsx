  ...
  const products = [
    {
      ...
      medium: "",
      info: `TSA NFT Broadway Series’s theme is inspired by the Legendary Song Dynasty painting “Along the River During the Qingming Festival”, also known in Chinese as Qingming Shanghe Tu (Simplified Chinese: 清明上河图). TSA Broadway embodies the spirit of Qingming Shanghe Tu, celebrating the excitement and hopes and dreams of collaborating in a new era of NFT, all in a beautiful and artistic format.`,
