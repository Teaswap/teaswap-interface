  ...
  const products = [
    {
      ...
      info:
        "A collection of 12,888 unique Penguins (Normal & Rare) curated by TSA incubator and living on the Ethereum, Polygon and Binance Smart Chain. Supporting Youth NFT Programs by giving 5% of proceeds received from public sale to the PenguinPunks NFT Staking Pool for learning adoption in DeFi.",
      joinUs: "penguinpunks",
