...
import { Currency, currencyEquals, ETHER, Percent, WETH } from '@teaswap/uniswap-sdk'
...
const RemoveLiquidity= () => {
  ...
  const [currencyA, currencyB] = [useCurrency(params.currencyIdA) ?? undefined, useCurrency(params.currencyIdB) ?? undefined]
  ...
  async function onRemove() {
    ...
    // await router['removeLiquidityWithPermit'](...args, {
    //   gasLimit: 350000
    // })
                    ...
                    {chainId && (oneCurrencyIsWETH || oneCurrencyIsETH) ? (
                      <RowBetween style={{ justifyContent: 'flex-end' }}>
                        {oneCurrencyIsETH ? (
                          ...
                          <StyledInternalLink
                            to={`/remove/${
                              currencyA && currencyEquals(currencyA, WETH[chainId]) ? 'BNB' : params.currencyIdA
                            }/${currencyB && currencyEquals(currencyB, WETH[chainId]) ? 'BNB' : params.currencyIdB}`}
                          >
                            {t('receive')} BNB
                          </StyledInternalLink>
                        ) : null}
