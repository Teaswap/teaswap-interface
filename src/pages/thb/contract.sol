...
//fork from hashLips Amended by Just
/**
    These contracts have been used to mint PengGuin brothers NFT
*/
...
// File: @openzeppelin/contracts/token/ERC721/NFT.sol
pragma solidity ^0.8.0;
/**
...
contract NFT is ERC721Enumerable, Ownable {
    ...
    address public feeAddress = 0x8Dd410E3f3fd3C083A37E6c4D32949d91511d371;
    ...
    // public
    function _mintTo(address _to, uint256 _count) internal {
        ...
        require(balance + _count <= maxMintPerAccount);
    ...
    function withdrawFee(uint256 _value) internal {
        (bool os2, ) = payable(feeAddress).call{value: _value}("");
        require(os2, _value.toString());
    }
